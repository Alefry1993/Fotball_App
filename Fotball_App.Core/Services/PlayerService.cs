...
public class PlayerService : IPlayerService
{
    ...
    {
        HttpResponseMessage httpResponseMessage = await _httpClient.PostAsJsonAsync($"Player", player);
    ...
    public async Task<IEnumerable<PlayerDto>> GetPlayersAsync()
    {
        ...
        HttpResponseMessage httpResponseMessage = await _httpClient.GetAsync("Player?");
    ...
    {
        HttpResponseMessage httpResponseMessage = await _httpClient.PutAsJsonAsync($"Players", player);
        return await httpResponseMessage.Content.ReadFromJsonAsync<PlayerDto>();
    }
}
}
